...
document.getElementById('exit').addEventListener('click', function(){
    ...
    TweenMax.to('#exit', 1, {delay: 1.5, rotation: '900deg', ease: Power3.easeInOut});
    ...
    TweenMax.to('#generalctn', 1, {delay: 2, rotation: "1080deg", ease: Power3.easeInOut});
...
document.getElementById('generalctn').addEventListener('click', function(){
    TweenMax.to('#generalctn', 1, {rotation: "0deg", ease: Power3.easeInOut});
    ...
    TweenMax.to('#exit', 2, { rotation: '0deg', ease: Power3.easeInOut});
